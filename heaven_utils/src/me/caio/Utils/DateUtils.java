...
public class DateUtils {
	...
	public static String formatDifference(long time) {
		...
		if (day > 0L) {
			sb.append(day).append(" ").append(day == 1L ? "dia" : "dias").append("§7,§c ");
		}
		if (hours > 0L) {
			sb.append(hours).append(" ").append(hours == 1L ? "hora" : "horas").append("§7,§c ");
		}
		if (minutes > 0L) {
			sb.append(minutes).append(" ").append(minutes == 1L ? "minuto" : "minutos").append(" §7e§c ");
		}
		if (seconds > 0L) {
